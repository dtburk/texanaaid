...
#' @param prob_mtrx A matrix with (named) columns for words, and rows for either
#'   documents or document groups. If each row represents a document,
#'   \code{group_membership} must be provided.
...
#' @param group_membership An integer vector specifying the group membership of
#'   documents in \code{prob_mtrx}.
#' @export
